    ...
    return(
        <div>
            <div className="mt-[9rem] flex ">
                ...
                /> */}
                <p className="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique accusamus error totam quibusdam sapiente magni debitis laboriosam quae odit labore voluptates pariatur id laborum nobis reprehenderit quo ex sequi sunt, et praesentium numquam a consequuntur iste omnis? Dolor aperiam sunt, consequuntur eveniet est excepturi rerum exercitationem dolorem a impedit officia, labore hic architecto quibusdam beatae ea dolores voluptates dignissimos vitae voluptatibus mollitia repudiandae sed neque corrupti! Ea fugiat totam nulla nisi ratione hic illo itaque veritatis voluptate, quos voluptatum voluptatem a non ipsum ex? Harum voluptatem aut tenetur pariatur. 
                <Image
                src="/imgs/maersk-air-cargo.avif"
                alt="About first image"
                height={100}
                width={900}
                className=" w-full h-[130px] bg-center flex p-4 justify-end"
                />Dolore maiores vel tempora quo. Modi officiis incidunt odit culpa natus.</p>
            </div>
            ...
            >              <Image
                            ...
                            width={600}
                            height={100}
                            className="w-full h-[200px] max-w-full rounded-sm shadow-md object-cover"
                            priority
                          />
                        </motion.div>
