  ...
  return (
      ...
      <div className="p-4  sm:p-8 max-w-7xl mx-auto  bg-[#131212]">
        ...
        <div className="flex flex-col md:flex-row items-center shadow-md rounded-2xl p-6 md:p-8 gap-6">
          <Image
            src="/imgs/sectionA.jpg"
            alt="Pricing illustration"
            width={300}
            height={200}
            className="md:w-1/2 h-auto o"
          />
          <motion.div
            className="absolute bg-black/33  sm:bg-[#131212] justify-center items-center sm:relative flex flex-col md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 "
          ...
          >
            ...
            <p className="text-gray-200 text-center flex-col leading-relaxed text-sm md:text-base">
              At FastShip Logistics, we offer transparent and flexible pricing <br/> designed to suit every shipping need, whether <br/> you’re sending a small package or managing large-scale logistics. </p>
            <span className="rounded-sm p-2 sm:w-[12vw] w-[55vw] flex justify-center text-black bg-white sm:p-2 m-2">Continue</span>
          </motion.div>
        </div>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 items-start">
            ...
            <motion.form
              className=" text-white rounded-lg shadow-md p-6 flex flex-col text-black"
